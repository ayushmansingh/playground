    ...
    >
      <div className="dashboard-chrome-inner dashboard-topbar-inner">
        <div className="dashboard-topbar-copy">
          ...
          {!build.label && mode !== "edit" && generatedAt && canEdit && showActions && surface !== "report" && (
          ...
          {!build.label && generatedAt && (!canEdit || !showActions) && surface !== "report" && (
            <span className="freshness freshness-label">
              <ReviewedFreshness generatedAt={generatedAt} />
            </span>
          )}
        ...
        {showActions && <div className="dashboard-topbar-mode-controls" ref={modeControls}>
