...
-- AND event_detail.ticket_details.quote_id = '45176812'
AND event_detail.ticket_details.generation_mode = 'DIY'
AND lower(event_detail.ticket_details.agent_id) not like '%mmt%'
),
...
-- b.quoteRequestId,
b.quote_id,
CASE WHEN a.quote_request_id is not null then 1 else 0 end as new_diy_flag,
...
FROM quote_actions b
LEFT JOIN he_diy_quotes a
